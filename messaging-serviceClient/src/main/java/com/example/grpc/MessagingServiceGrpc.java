...
public final class MessagingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.UserRequest,
      com.example.grpc.MessageResponse> getReceiveMessagesMethod;
  ...
  public static io.grpc.MethodDescriptor<com.example.grpc.UserRequest,
      com.example.grpc.MessageResponse> getReceiveMessagesMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.UserRequest, com.example.grpc.MessageResponse> getReceiveMessagesMethod;
      ...
      synchronized (MessagingServiceGrpc.class) {
        if ((getReceiveMessagesMethod = MessagingServiceGrpc.getReceiveMessagesMethod) == null) {
          MessagingServiceGrpc.getReceiveMessagesMethod = getReceiveMessagesMethod = 
              io.grpc.MethodDescriptor.<com.example.grpc.UserRequest, com.example.grpc.MessageResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
  ...
  public static abstract class MessagingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void receiveMessages(com.example.grpc.UserRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.MessageResponse> responseObserver) {
  ...
  public static final class MessagingServiceBlockingStub extends io.grpc.stub.AbstractStub<MessagingServiceBlockingStub> {
    ...
    /**
     */
    public com.example.grpc.MessageResponse receiveMessages(com.example.grpc.UserRequest request) {
      return blockingUnaryCall(
  ...
  public static final class MessagingServiceFutureStub extends io.grpc.stub.AbstractStub<MessagingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.MessageResponse> receiveMessages(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_RECEIVE_MESSAGES:
          serviceImpl.receiveMessages((com.example.grpc.UserRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.MessageResponse>) responseObserver);
          break;
        default:
